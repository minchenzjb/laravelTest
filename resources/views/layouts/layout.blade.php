...
<html lang="en">
    <head>
        ...
        <title>{{$title}} - Laravel Test Cart</title>
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +61 7 8888 8888</a></li>
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="{{url('cart')}}"><i class="fa fa-shopping-cart"></i> Cart({{$cartQuantity}})</a></li>
